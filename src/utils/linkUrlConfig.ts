...
export const userConfig = [
  {
    ...
    field: 'houseNumber',
    func: (val: any['roleAddressPlates']) =>
      val
        ? val
            .flatMap((p: any) => p.addressPlates.map((a: any) => a.houseNumber))
            .filter(
  ...
  },
  {
    ...
    name: 'birthday',
    field: 'age',
    func: (val: any['birthday']) => (val ? birthdayFormatAge(val) : '尚未填寫'),
    align: 'left',
    formType: 'inputString',
  },
  {
...
export const deviceListConfig = [
  {
    label: '維護廠商',
    name: 'maintainVendor',
    field: (row: { maintainVendor: any }) => row.maintainVendor?.name,
    align: 'left',
    formType: 'inputString',
    message: '請輸入 維護廠商',
    isTable: true,
  ...
  },
  {
    label: '設備狀況',
    name: 'condition',
    field: (row: any) => deviceStatus(row.condition),
    align: 'left',
    formType: 'inputString',
    message: '請輸入 設備狀況',
    isTable: true,
  ...
  },
  {
    ...
    field: (row: any) => row.lastMaintain?.completionDate,
    align: 'left',
    formType: 'date',
    message: '請選擇 上次保養時間',
    isTable: false,
